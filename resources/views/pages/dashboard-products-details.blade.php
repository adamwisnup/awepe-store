...
@section('title')
    AWEPE Store Dashboard Product Detail
@endsection
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="descrioption" id="" cols="30" rows="4"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <button class="btn btn-secondary btn-block mt-2" onclick="thisFileupload()">Add
                                            Photo</button>
                                    </div>
                                </div>
                            </div>
